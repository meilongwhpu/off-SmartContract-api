...
public class RpcAccountClientTest {
    ...
    private String address="tNULSeBaMvEtDfvZuukDf2mVyfGo3DdiN8KLRG2";
    ...
    public  void getAccount() throws Throwable{
        RpcResult result = memberClient.invoke("getAccount", new Object[] {chainId,assetId,address}, RpcResult.class);
        System.out.println(result);
    }

    @Test
    public  void getAccountList() throws Throwable{
        RpcResult result = memberClient.invoke("getAccountList", new Object[] {chainId,pageNumber,pageSize}, RpcResult.class);
        System.out.println(result);
    }
    ...
    public  void exportAccountKeyStore() throws Throwable{
        ...
        RpcResult result = memberClient.invoke("exportAccountKeyStore", new Object[] {chainId,address,password,filePath}, RpcResult.class);
        System.out.println(result);
    }
    ...
    public  void exportPriKeyByAddress() throws Throwable{
        RpcResult result = memberClient.invoke("exportPriKeyByAddress", new Object[] {chainId,address,password}, RpcResult.class);
        System.out.println(result);
    }
    ...
    public  void importAccountByPriKey() throws Throwable{
        ...
        RpcResult result = memberClient.invoke("importAccountByPriKey", new Object[] {chainId,priKey,password,true}, RpcResult.class);
        System.out.println(result);
    }
